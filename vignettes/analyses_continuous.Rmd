...
For the standardization estimator computed by `standardization()`, the corresponding small-sample variance correction is `standardization_df_adjust_tsiatis_2008()`: this adjusts the variance according to the sample size in each arm and the number of parameters in each regression model.
