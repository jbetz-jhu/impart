...
test_that(
  desc = "Continuous Outcome Check - Final",
  code = {
    expect_no_condition(
      object = count_outcomes(
...
colon_cancer_active_prepared_50_pct <-
  data_at_time_t(
...
test_that(
  desc = "Time-to-Event Outcome Check - Final",
  code = {
    expect_no_condition(
      object =
        count_outcomes(
...
test_that(
  desc = "Time-to-Event Outcome Check - 50%",
  code = {
    expect_no_condition(
      object =
        count_outcomes(
